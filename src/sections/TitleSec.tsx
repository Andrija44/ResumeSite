    ...
    return (
        <div className="title-sec">
            ...
            <p className="title-description">
                {lang === "hr" ?
                "Student sam računarstva na Sveučilištu u Zagrebu, Fakultetu elektrotehnike i računarstva. Zainteresiran sam za programiranje, razvoju aplikacija za web i progrmaskom inženjerstvu. Ovo je moja osobna stranica na kojoj možete pronaći informacije o mojim projektima, vještinama i obrazovanju." :
